        ...
        viewModel.name.observe(viewLifecycleOwner) {
            ...
            lifecycleScope.launch {
                if (it.toString().isNotEmpty()) {
                    ...
                    viewModel.getCharacters(status, gender, "").collect(adapter::submitData)
                }
            }
        }
        viewModel.gender.observe(viewLifecycleOwner) {
            ...
            lifecycleScope.launch {
                if (it.toString().isNotEmpty()) {
                    ...
                    viewModel.getCharacters(status, "", name).collect(adapter::submitData)
                }
            }
        }
        viewModel.status.observe(viewLifecycleOwner) {
            ...
            lifecycleScope.launch {
                if (it.toString().isNotEmpty()) {
                    ...
                    viewModel.getCharacters("", gender, name).collect(adapter::submitData)
                }
            }
        }
